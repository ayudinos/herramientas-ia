...
## APIs, Data and ML
  ...
  * [toolpipe.dev](https://toolpipe.dev) — 238+ free developer utility APIs: QR codes, JSON formatting, hashing, UUID, DNS lookup, regex testing, JWT decoding, code review, PDF tools, SEO analysis, and more. No API key required for free tier. Also available as an MCP server for AI agents.
